...
import { c as createExports } from './chunks/entrypoint_Bh297ZFd.mjs';
import { manifest } from './manifest_BNk3kelE.mjs';
...
const _page8 = () => import('./pages/reporte.astro.mjs');
const _page9 = () => import('./pages/signin.astro.mjs');
const _page10 = () => import('./pages/sorteo.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/reporte.astro", _page8],
    ["src/pages/signin.astro", _page9],
    ["src/pages/sorteo.astro", _page10],
...
const _args = {
    "middlewareSecret": "7f95b014-c0e1-4cd3-90e8-736ad4f27cf9",
